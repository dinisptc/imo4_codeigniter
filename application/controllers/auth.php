	...
	function index()
	{
		...
		elseif (!$this->ion_auth->is_admin()) //remove this elseif if you want to enable this for non-admins
		{
			...
			//return show_error('You must be an administrator to view this page.');
                        ...
                        $this->template->write_view('content', 'auth/erro_admin',$DContent,true);
		...
		else
		{
			...
			//$this->_render_page('auth/index', $this->data);
                        ...
                        $this->template->write_view('head', 'html/head');
                        $this->template->write_view('header', 'html/header');
                        $this->template->write_view('content', 'auth/index',$DContent,true);
                        $this->template->write_view('footer', 'footer/footer');
                        $this->template->render();
		}
	}
	...
	function login()
	{
		...
		else
		{
			...
			//$this->_render_page('auth/login', $this->data);
                        ...
                        $this->template->write_view('head', 'html/head');
                        $this->template->write_view('header', 'html/header');
                        $this->template->write_view('content', 'auth/login',$DContent,true);
                        $this->template->write_view('footer', 'footer/footer');
                        $this->template->render();
		}
	}
		...
		if ($this->form_validation->run() == false)
		{
			...
			//$this->_render_page('auth/change_password', $this->data);
                        ...
                        $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                                ...
                                $this->template->write_view('head', 'html/head');
                                $this->template->write_view('header', 'html/header');
                                $this->template->write_view('content', 'auth/change_password',$DContent,true);
                                $this->template->write_view('footer', 'footer/footer');
                                $this->template->render();
		}
		else
		...
		if ($this->form_validation->run() == false)
		{
			...
			//$this->_render_page('auth/forgot_password', $this->data);
                        ...
                        $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                                ...
                                $this->template->write_view('head', 'html/head');
                                $this->template->write_view('header', 'html/header');
                                $this->template->write_view('content', 'auth/forgot_password',$DContent,true);
                                $this->template->write_view('footer', 'footer/footer');
                                $this->template->render();
		}
		else
			...
			if ($this->form_validation->run() == false)
			{
				...
				//$this->_render_page('auth/reset_password', $this->data);
                              ...
                              $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                                ...
                                $this->template->write_view('head', 'html/head');
                                $this->template->write_view('header', 'html/header');
                                $this->template->write_view('content', 'auth/reset_password',$DContent,true);
                                $this->template->write_view('footer', 'footer/footer');
                                $this->template->render();
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			//$this->_render_page('auth/deactivate_user', $this->data);
                      ...
                      $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                        ...
                        $this->template->write_view('head', 'html/head');
                        $this->template->write_view('header', 'html/header');
                        $this->template->write_view('content', 'auth/deactivate_user',$DContent,true);
                        $this->template->write_view('footer', 'footer/footer');
                        $this->template->render();
		}
		else
		...
		else
		{
			...
			//$this->_render_page('auth/create_user', $this->data);
                     ...
                     $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                        ...
                        $this->template->write_view('head', 'html/head');
                        $this->template->write_view('header', 'html/header');
                        $this->template->write_view('content', 'auth/create_user',$DContent,true);
                        $this->template->write_view('footer', 'footer/footer');
                        $this->template->render();
	...
	function edit_user($id)
	{
		...
		//$this->_render_page('auth/edit_user', $this->data);
           ...
           $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                ...
                $this->template->write_view('head', 'html/head');
                $this->template->write_view('header', 'html/header');
                $this->template->write_view('content', 'auth/edit_user',$DContent,true);
                $this->template->write_view('footer', 'footer/footer');
                $this->template->render();
		...
		else
		{
			...
			//$this->_render_page('auth/create_group', $this->data);
                    ...
                    $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                        ...
                        $this->template->write_view('head', 'html/head');
                        $this->template->write_view('header', 'html/header');
                        $this->template->write_view('content', 'auth/create_group',$DContent,true);
                        $this->template->write_view('footer', 'footer/footer');
                        $this->template->render();
		}
	}
	...
	function edit_group($id)
	{
		...
		//$this->_render_page('auth/edit_group', $this->data);
            ...
            $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                ...
                $this->template->write_view('head', 'html/head');
                $this->template->write_view('header', 'html/header');
                $this->template->write_view('content', 'auth/edit_group',$DContent,true);
                $this->template->write_view('footer', 'footer/footer');
                $this->template->render();
	...
	function edit_user_group($id)
	{
		...
		if (isset($_POST) && !empty($_POST))
		{
			...
			if (isset($groupData) && !empty($groupData)) {
                                ...
                                //$this->ion_auth->db->trans_begin();   
                                   
				$this->ion_auth->remove_from_group(NULL, $id);
                                
                                
                               // $this->ion_auth->db->trans_commit();
				...
				foreach ($groupData as $grp) {
					$this->ion_auth->add_to_group($grp, $id);
                        ...
                        if($groupData[0]==3)
                        {
                          ...
                          $this->quartos_model->update_paydate($id);
                          
                            
                        }
                            
                        //update payed date on users table
		...
		$this->data['currentGroups'] = $currentGroups;
	        ...
	        $DContent['page_details'] = array('page_title' => 'Index of dinispt');
              ...
              $Dmeta = array('meta_title'=>'Welcome to IMO4/BemVindo ao IMO4','meta_descricao'=>'Real estate web site / Site de imoveis');
                ...
                $this->template->write_view('head', 'html/head');
                $this->template->write_view('header', 'html/header');
                $this->template->write_view('content', 'auth/edit_user_group',$DContent,true);
                $this->template->write_view('footer', 'footer/footer');
                $this->template->render();
